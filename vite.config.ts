 ...
 * @LastEditTime: 2021-07-18 23:13:09
 * @FilePath: \vue3.0-vite.20-element-plus\vite.config.ts
 */
...
export default defineConfig({
	...
	resolve: {
		...
		alias: {
			...
			icons: path.resolve(__dirname, 'src/components/svgIcon')
		}
	},
	// esbuild: {
