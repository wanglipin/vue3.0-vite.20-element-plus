        ...
        <div class="drawer-container">
          <header class="drawer-title" v-if="withHeader && title">
            ...
            <div class="drawer__close-btn_default">
              <button class="drawer__close-btn" v-if="showClose" @click="handleClose">
...
export default defineComponent({
  ...
  props: {
    ...
    withHeader: { // 设置此项为false 控制是否显示 header 栏, 默认为 true, 当此项为 false 时, title attribute 和 title slot 均不生效
      type: Boolean,
      default: () => {
        return true
      }
